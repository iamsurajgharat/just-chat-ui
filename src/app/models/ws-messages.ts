...
export const TypeName_ResponseConnected = 'actors.UserSessionActor.Connected'
export const TypeName_ResponsePinnedChats = 'actors.UserSessionActor.PinnedChats'
...
export class ConnectRequest implements BaseOutgoingMessage {
    _type = 'actors.UserSessionActor.Connect'
